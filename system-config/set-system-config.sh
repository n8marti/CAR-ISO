...
apt-get update
# "--with-new-pkgs" option allows to install new dependencies (after point releases?).
apt-get upgrade --assume-yes --with-new-pkgs
...
read -p "You can close Wasta [Offline] now. You may also want to run
Wasta [Offline] Setup at this point."
# Change locale; set regional number format.
update-locale LANG=fr_FR.utf8 LC_ALL=fr_FR.utf8
# Not sure about locale names. Here's a 2nd option:
#sudo update-locale LANG=fr_FR.UTF-8 LC_ALL=fr_FR.UTF-8
# TODO: Still not sure if this worked. Need to check on an English install.
...
# ===========================================================================
rsync ./Babylon* /usr/share/wasta-resources/.goldendict-dictionaries
